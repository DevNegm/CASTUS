                        ...
                        <div className="col-lg-12">
                            <div className="banner-content ta-animated-headline">
                                <h2 className="title ah-headline wow fadeInUp" data-wow-delay=".2s">
                                    <span>Whatever You want to ask- Castus has the </span>
                                    <Typewriter tag="span"
                                        options={{
                                ...
                                <h2 className="title d-none wow fadeInUp" data-wow-delay=".2s">Whatever You want to ask- Castus has the <span>Answers,</span> <span>Solutions</span></h2>
