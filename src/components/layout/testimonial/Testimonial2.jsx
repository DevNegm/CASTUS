          ...
          <Slider {...settings} className="row testimonial-active-two">
            ...
            <div className="col-lg-4">
              <div className="testimonial-item-two">
                ...
                <div className="testimonial-content-two">
                  <p>
                    We're using Castus to create explainer videos. It's just
                    easier, faster, and more cost-effective to use Castus than
              ...
              <div className="testimonial-item-two">
                ...
                <div className="testimonial-content-two">
                  <p>
                    ...
                    Castus Amazing platform! I was able to create a
